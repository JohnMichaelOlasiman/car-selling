    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        for (int i = 0; i < seedSpecs.Length; i++)
        {
            ...
            seededCars.Add(new Car
            {
                ...
                ImageUrls = urls,
                DateAdded = DateTime.UtcNow.AddDays(-i * 2), // varied DateAdded
